...
const testimonials = [
  ...
  {
    testimonial:
      "I've never met a web developer who truly cares about their clients' success like Vee does.",
    name: "Chris Brown",
    designation: "COO",
    company: "DEF Corp",
  ...
  {
    testimonial:
      "After Vee optimized our website, our traffic increased by 50%. We can't thank them enough!",
    name: "Lisa Wang",
    designation: "CTO",
