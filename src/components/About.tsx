...
const ServiceCard: React.FC<{ index: number; title: string; icon: string }> = ({
  ...
  <Tilt {...{ max: 45, scale: 1, speed: 450 }}>
    <motion.div
      ...
      className="w-full bg-[#0696a3] p-[1px] rounded-[20px] shadow-card mb-6"
...
const About: React.FC = () => {
  return (
    <div className="p-2 mt-3 mx-auto text-center">
      ...
      <motion.div
        ...
        initial="hidden"
        animate="show"
        className="flex flex-row flex-wrap gap-10 mt-20 p-4 justify-center"
      >
